...
public class MainActivity extends AppCompatActivity {
    ...
    public int letrasacertadas;
    public double progressoPor;
            ...
            if (emm.length() == 1){
                ...
                if (palavraSoteada.contains(emm)){ //se a letra esta na palavra
                    ...
                    for(int i = 0; i < palavraSoteada.length(); i++){
                        ...
                        if(letra == letraDaStr){ //acertou letra
                    ...
                    progressoPor =  ((double) letrasacertadas / (double) palavraSoteada.length()) * 100.0;
                    loadProgress((int) Math.round(progressoPor));
                } else {
                    vidas += 1;
    ...
    public void loadProgress(int B) {
            progressBarHorizontal.setProgress(B);
